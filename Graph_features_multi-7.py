...
if subset:
    training_set = [training_set[i] for i in range(16)]
    testing_set = [testing_set[i] for i in range(16)]
...
def process_testing():
    ...
    for i in range(len(testing_set)):
        ...
        log = 'test set : ' + str(i+1) + '/' + str(len(testing_set))
        print(log)
...
if __name__ == '__main__':
    processes = []
    for f in [process_training_1, process_training_2, process_training_3,
    process_training_4, process_training_5, process_training_6, process_testing]:
        p = Process(target=f)
        p.start()
        processes.append(p)
